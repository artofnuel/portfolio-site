      ...
      <div className="fixed z-30 top-0 w-full h-[50px]">
        <div className="backdrop-blur-[2px] bg-secondary/75 flex justify-between items-center w-11/12 md:max-w-7xl mx-auto py-2">
          ...
          <ul className="hidden lg:flex space-x-6 text-xl">
            ...
            <li className="cursor-pointer hover:text-primary" href="/">
              <a target="_blank" href="https://artofnuel.mypixieset.com/">
                ArtofNuel?
              </a>
            </li>
          </ul>
        ...
        <ul
          className={
            !nav
              ? "hidden"
              : "lg:hidden absolute top-0 left-0 w-full h-screen flex flex-col justify-center items-center mx-auto space-y-10 text-3xl bg-background"
          }
        >
          <li className="cursor-pointer hover:text-primary" href="/">
        ...
        <div className="hidden fixed lg:flex flex-col top-[35%] left-0">
          <ul className="flex flex-col space-y-2">
            <li className="w-[140px] p-1 px-5 flex justify-center items-center ml-[-75px] hover:ml-[-5px] duration-500 border-2 border-primary  rounded-r-full">
              <a
            ...
            <li className="w-[150px] p-1 px-5 flex justify-center items-center ml-[-85px] hover:ml-[-5px] duration-500 border-2 border-primary  rounded-r-full">
              <a
                className="w-full flex justify-between items-center text-primary"
                target="_blank"
