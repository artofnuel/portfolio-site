...
const Hero = () => {
    return (
        <div name='home' className='relative max-w-6xl h-screen md:h-full flex flex-col w-full justify-center items-center mx-auto'>
            ...
            <div className='lg:hidden p-4 absolute bottom-12 flex justify-start items-center space-x-5 w-full pt-5'>
                ...
                <div className='flex justify-center items-center space-x-5 w-full'>
                    <a className='hover:text-primary md:text-gray' href=""><FiLinkedin size={25} /></a>
                    <a className='hover:text-primary md:text-gray' href=""><FiGithub size={25} /></a>
                    <a className='hover:text-primary md:text-gray' href=""><FiTwitter size={25} /></a>
                    <a className='hover:text-primary md:text-gray' href=""><MdOutlineMarkEmailUnread size={25} /></a>
                </div>
            </div>
        </div>
    )
