...
const Skills = () => {
    return (
        <div name='skills' className='py-20 w-full flex justify-center items-center '>
            <div className="max-w-6xl w-full p-4 flex flex-col justify-between items-start mx-auto ">
                ...
                <div className='max-w-6xl w-full mx-auto grid grid-cols-2 sm:grid-cols-3 gap-4 text-center py-8'>
                    <div className='flex flex-col justify-center items-center py-8 text-primary shadow shadow-[rgb(28,28,28)]/25 rounded-xl hover:scale-105 duration-500'>
                        <TfiHtml5 size={80} />
